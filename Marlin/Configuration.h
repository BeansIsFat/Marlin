...
#define STRING_CONFIG_H_AUTHOR "(BeansIsFat, CC300 Stock)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  16.15
    #define DEFAULT_Ki   1.13
    #define DEFAULT_Kd  57.95
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  40.6
  #define DEFAULT_bedKi   7.86
  #define DEFAULT_bedKd 142.29
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 1.15, -28.25, -1.14 }
...
#define MANUAL_Y_HOME_POS 303.4
